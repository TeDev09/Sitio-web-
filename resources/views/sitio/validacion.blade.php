            ...
            <div class="row">
                <div>
                    ...
                    <div class="center">
                        ...
                        <br>
                        <a style="display: block;" href="{{ route('principal') }}" class="waves-effect waves-light btn green">INGRESAR</a>
                    </div>
                </div>
                @endif
                <?php
